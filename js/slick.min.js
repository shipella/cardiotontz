  ...
  ((b = (function () {
    ...
    return function (d, f) {
      ...
      (g.defaults = {
        ...
        (g.windowTimer = null),
        (e = a(d).data("slick") || {}),
        (g.options = a.extend({}, g.defaults, f, e)),
    ...
    (b.prototype.animateSlide = function (f, c) {
      var g = {},
        d = this;
      d.animateHeight(),
        !0 === d.options.rtl && !1 === d.options.vertical && (f = -f),
    ...
    (b.prototype.applyTransition = function (d) {
      ...
      !1 === f.options.fade
        ...
        !1 === f.options.fade ? f.$slideTrack.css(c) : f.$slides.eq(d).css(c);
    }),
    ...
    (b.prototype.buildOut = function () {
      ...
      (c.$slides = c.$slider
        ...
        (!0 !== c.options.centerMode && !0 !== c.options.swipeToSlide) ||
      ...
      if (
        ...
        null !== p
            ...
            ? (p !== c.activeBreakpoint || m) &&
              ...
              "unslick" === c.breakpointSettings[p]
                ...
                : ((c.options = a.extend(
                  ...
                  !0 === i && (c.currentSlide = c.options.initialSlide),
                  c.refresh(i)),
              (h = p))
            : ((c.activeBreakpoint = p),
              "unslick" === c.breakpointSettings[p]
          ...
          : null !== c.activeBreakpoint &&
            ...
            c.refresh(i),
            (h = p)),
          i || !1 === h || c.$slider.trigger("breakpoint", [c, h]);
      }
    }),
    ...
    (b.prototype.cleanUpRows = function () {
      var c,
        d = this;
      d.options.rows > 1 &&
        ((c = d.$slides.children().children()).removeAttr("style"),
    ...
    (b.prototype.focusHandler = function () {
      ...
      c.$slider
        ...
        .on("focus.slick blur.slick", "*", function (d) {
          d.stopImmediatePropagation();
          var e = a(this);
          setTimeout(function () {
            c.options.pauseOnFocus &&
              ((c.focussed = e.is(":focus")), c.autoPlay());
          }, 0);
        });
    }),
    ...
    (b.prototype.getLeft = function (d) {
      ...
      return (
        ...
        k.slideCount <= k.options.slidesToShow &&
          ((k.slideOffset = 0), (g = 0)),
        !0 === k.options.centerMode && k.slideCount <= k.options.slidesToShow
          ? (k.slideOffset =
              (k.slideWidth * Math.floor(k.options.slidesToShow)) / 2 -
              (k.slideWidth * k.slideCount) / 2)
          : !0 === k.options.centerMode && !0 === k.options.infinite
          ? (k.slideOffset +=
              k.slideWidth * Math.floor(k.options.slidesToShow / 2) -
              k.slideWidth)
          : !0 === k.options.centerMode &&
            ...
            (k.slideOffset +=
              k.slideWidth * Math.floor(k.options.slidesToShow / 2))),
        (h =
          !1 === k.options.vertical
            ? d * k.slideWidth * -1 + k.slideOffset
            : d * c * -1 + g),
        !0 === k.options.variableWidth &&
          ((j =
            k.slideCount <= k.options.slidesToShow || !1 === k.options.infinite
          ...
          (h =
            !0 === k.options.rtl
              ? j[0]
                ? -1 * (k.$slideTrack.width() - j[0].offsetLeft - j.width())
                : 0
              : j[0]
              ? -1 * j[0].offsetLeft
              : 0),
    ...
    (b.prototype.getNavigableIndexes = function () {
      ...
      for (
        !1 === g.options.infinite
          ? (d = g.slideCount)
          : ((c = -1 * g.options.slidesToScroll),
            (h = -1 * g.options.slidesToScroll),
            (d = 2 * g.slideCount));
        c < d;
      ...
      return (
        (c =
          !0 === f.options.centerMode
            ...
            : 0),
        !0 === f.options.swipeToSlide
          ? (f.$slideTrack.find(".slick-slide").each(function (e, g) {
              if (g.offsetLeft - c + a(g).outerWidth() / 2 > -1 * f.swipeLeft) {
                return (d = g), !1;
              }
            }),
            Math.abs(a(d).attr("data-slick-index") - f.currentSlide) || 1)
            ...
            .each(function (e) {
              ...
              a(this).attr({
                ...
                -1 !== i &&
                  a(this).attr({
                    "aria-describedby":
                      "slick-slide-control" + f.instanceUid + i,
                  });
            }),
          f.$dots
            .attr("role", "tablist")
    ...
    (b.prototype.keyHandler = function (c) {
      ...
      c.target.tagName.match("TEXTAREA|INPUT|SELECT") ||
        (37 === c.keyCode && !0 === d.options.accessibility
          ? d.changeSlide({
    ...
    (b.prototype.lazyLoad = function () {
        ...
        a("img[data-lazy]", d).each(function () {
          ...
          (q.onload = function () {
            u.animate({ opacity: 0 }, 100, function () {
              v && (u.attr("srcset", v), n && u.attr("sizes", n)),
                u.attr("src", l).animate({ opacity: 1 }, 200, function () {
            ...
            (q.onerror = function () {
              u
                ...
                g.$slider.trigger("lazyLoadError", [g, u, l]);
            }),
            (q.src = l);
        });
      }
      ...
      if (
        (!0 === g.options.centerMode
          ? !0 === g.options.infinite
            ? (p =
                (f = g.currentSlide + (g.options.slidesToShow / 2 + 1)) +
                g.options.slidesToShow +
                2)
            : ((f = Math.max(
                0,
              ...
              (p = g.options.slidesToShow / 2 + 1 + 2 + g.currentSlide))
          : ((f = g.options.infinite
              ? g.options.slidesToShow + g.currentSlide
              : g.currentSlide),
            (p = Math.ceil(f + g.options.slidesToShow)),
            !0 === g.options.fade && (f > 0 && f--, p <= g.slideCount && p++)),
        (m = g.$slider.find(".slick-slide").slice(f, p)),
        "anticipated" === g.options.lazyLoad)
      ) {
        for (
          var c = f - 1, h = p, j = g.$slider.find(".slick-slide"), k = 0;
          k < g.options.slidesToScroll;
          k++
        ) {
          c < 0 && (c = g.slideCount - 1),
            (m = (m = m.add(j.eq(c))).add(j.eq(h))),
            c--,
            h++;
        }
      }
      i(m),
        g.slideCount <= g.options.slidesToShow
          ? i(g.$slider.find(".slick-slide"))
          : g.currentSlide >= g.slideCount - g.options.slidesToShow
          ? i(g.$slider.find(".slick-cloned").slice(0, g.options.slidesToShow))
          : 0 === g.currentSlide &&
            i(
              g.$slider.find(".slick-cloned").slice(-1 * g.options.slidesToShow)
            );
    }),
    ...
    (b.prototype.progressiveLazyLoad = function (i) {
      ...
      j.length
        ? ((f = j.first()),
          ...
          ((h = document.createElement("img")).onload = function () {
    ...
    (b.prototype.setDimensions = function () {
      ...
      !1 === c.options.vertical
        ...
        !1 === c.options.vertical && !1 === c.options.variableWidth
    ...
    (b.prototype.setProps = function () {
      ...
      (c.positionProp = !0 === c.options.vertical ? "top" : "left"),
        "top" === c.positionProp
        ...
        (void 0 === d.WebkitTransition &&
          ...
          (!0 === c.options.useCSS && (c.cssTransitions = !0)),
        c.options.fade &&
        ...
        (c.transformsEnabled =
          c.options.useTransform && null !== c.animType && !1 !== c.animType);
    }),
      ...
      if (
        ...
        d >= 0 && d <= k.slideCount - k.options.slidesToShow
          ...
          : ((f = k.slideCount % k.options.slidesToShow),
            (j = !0 === k.options.infinite ? k.options.slidesToShow + d : d),
    ...
    (b.prototype.setupInfinite = function () {
      var f,
        ...
        d = this;
      if (
        (!0 === d.options.fade && (d.options.centerMode = !1),
    ...
    (b.prototype.slideHandler = function (j, k, q) {
      ...
      if (
        ...
        !(
          ...
          (!0 === p.options.fade && p.currentSlide === j)
        ))
      ) {
        if (
          (!1 === k && p.asNavFor(j),
          ...
          if (
            ...
            if (
              ...
              p.options.asNavFor &&
                (h = (h = p.getNavTarget()).slick("getSlick")).slideCount <=
    ...
    (b.prototype.swipeDirection = function () {
      ...
      return (
        ...
        (c = Math.atan2(g, d)),
        (h = Math.round((180 * c) / Math.PI)) < 0 && (h = 360 - Math.abs(h)),
        h <= 45 && h >= 0
          ? !1 === f.options.rtl
            ? "left"
            : "right"
    ...
    (b.prototype.swipeHandler = function (c) {
      ...
      if (
        !(
          ...
          (!1 === d.options.draggable && -1 !== c.type.indexOf("mouse"))
        )
      ) {
        switch (
        ...
        !(!c.dragging || c.scrolling || (m && 1 !== m.length)) &&
          ...
          !c.options.verticalSwiping && !c.swiping && h > 4
            ...
            : (!0 === c.options.verticalSwiping &&
              ...
              !0 === c.options.verticalSwiping && (c.swipeLeft = j + k * g),
              !0 !== c.options.fade &&
