        ...
        return (
          (this.getPropertyValue = function (a) {
            ...
            return (
              ...
              l.test(a) &&
                a.replace(l, function (g, f) {
                  return f.toUpperCase();
                }),
              (null != (e = d.currentStyle) ? e[a] : void 0) || null
            );
          }),
          this
        );
      ...
      return (
        ...
        (a.prototype.customStyle = function (g, f, q, p, o) {
          return (
            ...
            q && this.vendorSet(g.style, { animationDuration: q }),
            p && this.vendorSet(g.style, { animationDelay: p }),
            o && this.vendorSet(g.style, { animationIterationCount: o }),
